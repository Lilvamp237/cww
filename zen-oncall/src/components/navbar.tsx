...
import { MenuIcon, CalendarIcon, UsersIcon, HeartPulseIcon } from 'lucide-react';
...
export function Navbar({ user }: NavbarProps) {
  ...
  const navItems = [
    ...
    { href: '/wellness', label: 'Wellness', icon: HeartPulseIcon },
    { href: '/circles', label: 'Sync Circles', icon: UsersIcon }, // Now active
  ];
